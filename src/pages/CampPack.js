...
export default function CampPack() {
                                                        ...
                                                        <div className="pack_div">
                                                            ...
                                                            <div className="premium_btm_div">
                                                                ...
                                                                <div className="secTwo">
                                                                    <span className="quantity_num">35</span>
                                                    ...
                                                    <Link to="/confirm_goods/package_2" className="pack_link">
                                                        <div className="pack_div">
                                                            ...
                                                            <div className="premium_btm_div">
                                                                ...
                                                                <div className="secTwo">
                                                                    <span className="quantity_num">70</span>
                                                                    <span className="u">U</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <Link to="/confirm_goods/package_6" className="pack_link">
                                                        <div className="pack_div">
                                                            ...
                                                            <div className="premium_btm_div">
                                                                ...
                                                                <div className="secTwo">
                                                                    <span className="quantity_num">210</span>
                                                                    <span className="u">U</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <Col lg={12}>
                                                <Link to="/confirm_goods/package_11" className="exclusive_href" href="javascript:;">
                                                    <div className="premium_pack_div">
                                                        <div className="premium_label">Send 1 Package</div>
